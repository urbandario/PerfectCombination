...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>PerfectCombination</title>
        ...
        <style>
            ...
            body {
                ...
                background: linear-gradient(45deg, rgba(80,252,20,1) 17%, rgba(55,164,28,1) 46%, rgba(44,84,36,1) 85%); 
            }
        </style>
    </head>
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen sm:items-center sm:pt-0">
            ...
            <div class="text-center" style="margin:0 auto;">
                ...
                <h1 class="quote d-none d-sm-block">“When you’ve got something to prove, there’s nothing greater than a challenge.”</h1>
                <h1 class="quote d-block d-sm-none mt-5 pt-5">“When you’ve got something to prove, there’s nothing greater than a challenge.”</h1>
