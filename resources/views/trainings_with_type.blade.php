...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h3><span class="badge badge-success">{{ $type->name }}</span> Trainings <i class="fas fa-dumbbell"></i></h3></div>
                <div class="card-body">
                    <div class="row">
                        @foreach ($trainings as $training)
                            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 mb-4">
                                <div class="card">
                                    ...
                                    @endif
                                    <div class="card-body">
                                      <h5 class="card-title font-weight-bold">Name: {{ $training->name }} <span class="badge badge-success">{{ $training->type()->first()->name }}</span></h5>
